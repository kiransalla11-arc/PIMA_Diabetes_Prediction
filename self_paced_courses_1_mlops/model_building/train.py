...
Xtrain_path = "hf://datasets/kirankumarsalla/PIMA-Diabetes-Prediction/Xtrain.csv"                    # enter the Hugging Face username here
Xtest_path = "hf://datasets/kirankumarsalla/PIMA-Diabetes-Prediction/Xtest.csv"                      # enter the Hugging Face username here
ytrain_path = "hf://datasets/kirankumarsalla/PIMA-Diabetes-Prediction/ytrain.csv"                    # enter the Hugging Face username here
ytest_path = "hf://datasets/kirankumarsalla/PIMA-Diabetes-Prediction/ytest.csv"                      # enter the Hugging Face username here
